...
# Here we are using the 1: etc. as a key identifier to map the strings that are '1' etc
...
while playing:
    ...
    if choice == 'q':
        playing = False
        # check if the player gave the number from 1 to 9
    ...
    # check if the game has ended, and if someone has won
